	...
	public function select( $db, $dbh = null ) {
		...
		if ( ! $success ) {
			$this->ready = false;
				...
				$message .= '<p>If you don&#8217;t know how to set up a database you should <strong>contact your host</strong>. </p>';
        echo $message;
        exit();        
		}
	}
	...
	public function db_connect( $allow_bail = true ) {
		...
		if ( ! $this->dbh && $allow_bail ) {
			...
			$message .= '<p>' . sprintf(
				...
				'If you&#8217;re unsure what these terms mean you should probably contact your host. If you still need help you can always visit the <a href="%s">phpDivinglog Support Forums</a>.' ,
				 'https://www.divinglog.de/phpbb/viewforum.php?f=10' 
			) . "</p>\n";
