...
<table class="divetable" cellspacing="0" cellpadding="0" width="100%">
    ...
    {/if}
    {if $DateRN != ''}
      <td>{if $equip_datern_warning}<img src="{$web_root}/images/icon_warning_16.png" 
    ...
    {/if}
    {if $O2ServiceDate != ''}
      <td>{if $equip_o2servicedate_warning}<img src="{$web_root}/images/icon_warning_16.png" 
        border="0" width="16" height="16"
        alt="{$equip_service_warning}" title="{$equip_service_warning}"> {/if}{$O2ServiceDate}</td>
    {else}
      <td>-</td>
    {/if}
    {if $Weight != ''}
