...
<a href="{$app_path}/divecity.php/{$multiuser_id}{$list}" class="crumbs" title="{$dive_city_linktitle}">{$dive_cities}</a><br> 
...
<a href="{$app_path}/divesite.php{$list}" class="crumbs" 
title="{$dive_sites_linktitle}">{$dive_sites}</a><br> 
<a href="{$app_path}/equipment.php{$list}" class="crumbs" title="{$dive_equip_linktitle}">{$dive_equip}</a><br>
<a href="{$app_path}/diveshop.php{$list}" class="crumbs"
title="{$dive_shops_linktitle}">{$dive_shops}</a><br>
<a href="{$app_path}/divetrip.php{$list}" class="crumbs"
title="{$dive_trips_linktitle}">{$dive_trips}</a><br>
<a href="{$app_path}/divecountry.php{$list}" class="crumbs"
title="{$dive_country_linktitle}">{$dive_countries}</a><br>
<a href="{$app_path}/divecity.php{$list}" class="crumbs" 
title="{$dive_city_linktitle}">{$dive_cities}</a><br>
