{if $show_equip_service == 1}
  <h1><img src="{$app_path}/images/equipment_service.png" height="50" width="50" border="0"
    ...
    {section name=cell_data loop=$cells }
      <tr class="diveoverview">
        ...
        {if $cells[cell_data].Inactive == 'True'}
          <td><img src="{$app_path}/images/icon_inactive_16.png" border="0" alt="{$equip_inactive_inactive}"
              title="{$equip_inactive_inactive}"></td>
        {else}
          <td><img src="{$app_path}/images/icon_active_16.png" border="0" alt="{$equip_inactive_active}"
              title="{$equip_inactive_active}"></td>
        {/if}
        {if isset($cells[cell_data].PhotoPath) && $cells[cell_data].PhotoPath != ''}
          <td><img src="{$app_path}/images/photo_icon.gif" border="0"
              alt="{$equip_photo_linktitle}{$cells[cell_data].object}"
              title="{$equip_photo_linktitle}{$cells[cell_data].object}"></td>
        {else}
          <td>&nbsp;</td>
        {/if}
        {if $cells[cell_data].Service == '1'}
          <td><img src="{$app_path}/images/icon_warning_16.png" border="0" width="16" height="16"
